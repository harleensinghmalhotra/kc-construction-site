...
export default function GalleryPage() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Replaced a collapsed asphalt driveway with reinforced base and premium brick pavers.",
    },
    {
      before: "https://images.pexels.com/photos/1072179/pexels-photo-1072179.jpeg",
      after: "https://images.pexels.com/photos/1105766/pexels-photo-1105766.jpeg",
      title: "Lakefront Bluff Restoration",
      description:
        "Restored eroded slope with stabilized soil, cedar mulch beds, and expanded lakefront walkway.",
    },
    {
      before: "https://images.pexels.com/photos/2131784/pexels-photo-2131784.jpeg",
      after: "https://images.pexels.com/photos/1301856/pexels-photo-1301856.jpeg",
      title: "Seasonal Property Maintenance",
      description:
        "Fall cleanup, pruning, debris removal, edging, and fresh mulch application.",
    },
    {
      before: "https://images.pexels.com/photos/2495173/pexels-photo-2495173.jpeg",
      after: "https://images.pexels.com/photos/2102587/pexels-photo-2102587.jpeg",
      title: "Zen Garden & Water Feature",
      description:
        "Japanese-inspired side yard retreat with stone water feature and ornamental plantings.",
    },
  ];
